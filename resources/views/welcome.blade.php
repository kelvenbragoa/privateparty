...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('template/revolution-slider/fonts/font-awesome/css/font-awesome.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('template/revolution-slider/css/settings.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('template/revolution-slider/css/layers.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('template/revolution-slider/css/navigation.css')}}">
        ...
        <!-- END REVOLUTION SLIDER -->
         ...
         <div class="container margin_60">
            ...
            <div class="form-group">
                <input type="text" class="form-control" name="code" id="" placeholder="Digite seu código" required>
                <button type="submit" class="btn_1 medium gradient pulse_bt mt-2" id="buttonSubmit">Confirmar</button>
            </div>
...
<script src="{{asset('template/revolution-slider/js/jquery.themepunch.tools.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/jquery.themepunch.revolution.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.extension.actions.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.extension.carousel.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.extension.migration.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.extension.navigation.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.extension.parallax.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.extension.video.min.js')}}"></script>
<script src="{{asset('template/revolution-slider/js/extensions/revolution.addon.slicey.min.js')}}"></script>
<script>
var tpj = jQuery;
var revapi45;
